...
import plotly.express as px  # for data chart
...
def create_ui():
    ...
    with gr.Blocks(
        title="Traders", css=css, js=js, theme=gr.themes.Default(primary_hue="sky"), fill_width=True  # type: ignore[attr-defined]
    ) as ui:
        with gr.Row():
